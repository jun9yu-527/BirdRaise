...
void UIRenderer::ActionArtRender(const string& actionName, string name, int mainSat, int stress, int clean, int ful, int trn) {
    ...
    if (actionName == "품어주기") {
        actionArt1 = eggBrood1;
        actionArt2 = eggBrood2;
    }
    else if (actionName == "쓰다듬어주기") {
        actionArt1 = eggHug1;
        actionArt2 = eggHug2;
    }
    else if (actionName == "방 청소하기") {
        actionArt1 = roomClean1;
        actionArt2 = roomClean2;
    }
    ...
    else if (actionName == "학원 보내기") {
        actionArt1 = academy1;
        actionArt2 = academy2;
    }
    else if (actionName == "가볍게 놀아주기") {
